...
//
// Dois rótulos foram renomeados para o ranking não sugerir cliente onde não há:
//  - "Depósito em espécie (caixa eletrônico/agência)" → "Depósitos em dinheiro
//    (diligências)". CONTINUA contabilizado: é receita real, paga em dinheiro
//    (diligências e afins). Se alguma dessas entradas for parcela de um cliente,
//    o Dr. Gustavo identifica e reclassifica.
//  - "Lu" → "Lu — não identificado". Origem desconhecida; mantida na soma.
// Se este arquivo for regerado a partir das planilhas, reaplicar os dois rótulos.
...
export const HISTORICO_ANUAL: AnoHistorico[] = [
  {
    ...
    topClientes: [
      ...
      { nome: "Depósitos em dinheiro (diligências)", total: 4645.0 },
  ...
  },
  {
    ...
    nRecebimentos: 321,
    topClientes: [
      { nome: "Depósitos em dinheiro (diligências)", total: 6095.0 },
      { nome: "POLIANA NICOLY", total: 4300.0 },
      { nome: "Lu — não identificado", total: 4000.0 },
